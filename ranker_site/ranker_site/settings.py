"""
Django settings for ranker_site project.
...
SECRET_KEY = 'django-insecure-oh2z^h%li5m6%h89b8(_ivw)pw9%8x9emv&z89e=(i1dns9%#t'
...
AUTH_PASSWORD_VALIDATORS = [
    # commented only for easy of development
    # {
